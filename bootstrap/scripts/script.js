...
function openCart() {
    if(!localStorage.getItem('AuthAccepted')){ 
        alert("Авторизуйтесь для виконання покупок");    
        return false;}
...
function validateLoginForm() {
    ...
    if (!validatePassword(password)) {
        alert("Будь ласка, введіть коректний пароль");
        return false;
    }
    
    alert("Успішна валідація форми авторизації!");
    localStorage.setItem("AuthAccepted", "true");
    return true;
}
...
function validateRegistrationForm() {
    ...
    var email = document.getElementById("email").value;
    var password = document.getElementById("password").value;
    var password_d = document.getElementById("password_d").value;
    
    
    if (username === "" || email === "" || password === "" || password_d === "") {
        alert("Будь ласка, заповніть всі поля");
        return false;
    }
    ...
    alert("Успішна валідація форми реєстрації!");
    return true;
}
...
function validatePassword(password) {
    ...
    // Перевірка на наявність букв та цифр у паролі
